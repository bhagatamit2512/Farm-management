...
<html lang="en">
	...
	?>
		...
		<div class="footer-left">
			<h3 style="font-family: 'Times New Roman', cursive;">FarmFood &copy; </h3>
		<!--	<div class="logo">
		...
		<!--<div class="footer-center">
			...
			<div>
				...
				<p style="font-size:20px"><a href="mailto:FarmFood@gmail.com" style="color:white"></a></p>
			</div>
		</div>

		<div class="footer-right">
			<p class="footer-company-about" style="color:white">
				<span style="font-size:20px"><b>About FarmFood</b></span>
				FarmFood is e-commerce trading platform for grains & grocerries...
			</p>
